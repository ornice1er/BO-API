...
use App\Http\Requests\EntiteAdmin\StoreEntiteAdminRequest;
use App\Http\Requests\EntiteAdmin\UpdateEntiteAdminRequest;
...
class EntiteAdminController extends Controller
{
     ...
     * )
     */
    public function store(StoreEntiteAdminRequest $request)
    {
     ...
     * )
     */
    public function update(UpdateEntiteAdminRequest $request, $id)
    {
