...
namespace App\Http\Requests\EtapePrestationStatus;
...
class UpdateEtapePrestationStatusRequest extends FormRequest
{
    /**
    ...
    public function rules(): array
    {
        return [
            ...
            'ps_id' => 'required|integer|exists:prestation_status,id',
        ];
    }
