...
class UpdateVisaCAFilesRequest extends FormRequest
{
    /**
    ...
    public function rules(): array
    {
        return [
            ...
            'file' => [
                'nullable', // Optionnel lors de la mise à jour
                'file',
                'max:10240', // 10MB max
    ...
    {
        // Si un nouveau fichier est téléchargé et que le filename n'est pas fourni, utiliser le nom du fichier
