...
class StoreVisaRiesFilesRequest extends FormRequest
{
    /**
    ...
    /**
     * Règles de validation pour la création d'un fichier visa.
     */
    public function rules(): array
    {
        return [
            ...
            'visa_rie_id' => 'required|integer|exists:visa_r_i_e_s,id',
