...
class StoreMunicipalityGhmRequest extends FormRequest
{
    /**
    ...
    public function messages()
    {
        return [
            ...
            'department_id.required' => 'Le department est requis.',
            'department_id.exists' => 'Le department choisi  n\'existe pas.',
            'department_id.integer' => 'L\'id de department n\'est pas un entier .',
