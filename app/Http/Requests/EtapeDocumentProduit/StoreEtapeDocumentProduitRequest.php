...
class StoreEtapeDocumentProduitRequest extends FormRequest
{
    ...
    public function rules(): array
    {
        return [
            ...
            'numero_prefix'       => 'required|string|max:10',
            'template_key'        => 'nullable|required_if:generate_from,system|string|max:255',
    ...
    public function messages()
    {
        return [
            ...
            'numero_prefix.required'    => 'Le préfixe de numérotation est requis.',
            'type.required'             => 'Le type de document est requis.',
            'type.in'                   => 'Le type doit être : lettre, decision, attestation ou pv.',
            'template_key.required_if'  => 'La clé de template est requise lorsque le document est généré depuis le système.',
